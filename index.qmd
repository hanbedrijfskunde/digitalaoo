...
for question in questions:
    fig = make_subplots(rows=1, cols=len(personas_cnt['Toegewezen Persona']), specs=[[{'type':'domain'}]*len(personas_cnt['Toegewezen Persona'])],
                        subplot_titles=personas_cnt['Toegewezen Persona'])
